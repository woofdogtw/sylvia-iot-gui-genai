 ...
 * @param {string} filename - Suggested filename (e.g. 'users.csv')
...
/**
 * Stream response to a file using File System Access API with progress.
 */
...
/**
 * Fallback: download via Blob and URL.createObjectURL.
 */
