...
export default {
  'en-US': { ...enUS, ...sharedMessages['en-US'], ...coreMessages['en-US'], ...dataMessages['en-US'], ...routerMessages['en-US'] },
  'zh-TW': { ...zhTW, ...sharedMessages['zh-TW'], ...coreMessages['zh-TW'], ...dataMessages['zh-TW'], ...routerMessages['zh-TW'] },
}
