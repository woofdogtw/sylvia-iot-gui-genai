...
# Sylvia-Router Database Reset Script
...
echo "======================================"
echo "Reset Sylvia-Router Test Database"
echo "======================================"

# Check if sylvia-router is running
if [ -f "$PID_FILE" ] && kill -0 "$(cat "$PID_FILE")" 2>/dev/null; then
    echo ""
    echo "⚠️  Warning: sylvia-router is currently running"
